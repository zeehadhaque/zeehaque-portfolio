...
export const DIRECTOR_BIO = {
  ...
  portraitPlaceholder: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=1200&q=85", // Low-key moody portrait placeholder
...
export const SOCIAL_LINKS = [
  { label: "YouTube", href: "https://youtube.com/@zeehadhaque", handle: "@zeehadhaque", note: "[REPLACE WITH YOUR YOUTUBE URL]" },
  { label: "Instagram", href: "https://instagram.com/zeehadhaque", handle: "@zeehadhaque", note: "[REPLACE WITH YOUR INSTAGRAM URL]" },
  { label: "Facebook", href: "https://facebook.com/zeehadhaque", handle: "zeehadhaque", note: "[REPLACE WITH YOUR FACEBOOK URL]" },
  { label: "LinkedIn", href: "https://linkedin.com/in/zeehadhaque", handle: "in/zeehadhaque", note: "[REPLACE WITH YOUR LINKEDIN URL]" },
  { label: "IMDb / Letterboxd", href: "#", handle: "Zeehad Haque", note: "[ADD IMDB / LETTERBOXD PROFILE]" }
];
