      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 relative flex flex-row gap-6">
            ...
            {/* Director Portrait in 4:5 Cinema Framing */}
            <div className="flex-1 relative aspect-[4/5] rounded overflow-hidden bg-[#0c0d10] border border-white/15 shadow-2xl group">
              <img
                ...
                className="w-full h-full object-cover object-top filter contrast-[1.08] brightness-[0.96] group-hover:scale-103 transition-transform duration-1000"
              />
              <div className="cinematic-vignette absolute inset-0 opacity-60" />
              <div className="absolute inset-0 scanlines opacity-10 pointer-events-none" />

              {/* Slate Marks on Portrait */}
              <div className="absolute top-4 left-4 font-mono text-[9px] tracking-widest text-white/90 bg-black/75 px-2.5 py-1 rounded backdrop-blur-sm border border-white/10 flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#b91c1c] animate-pulse" />
                <span>DIRECTOR // ZEEHAD HAQUE</span>
              </div>
              <div className="absolute bottom-4 left-4 right-4 font-mono text-[10px] tracking-widest text-zinc-300 bg-black/85 p-2.5 rounded border border-white/10 backdrop-blur-md flex items-center justify-between">
                <span>ZEEHAD HAQUE</span>
                <span className="text-[#b91c1c] font-bold">DIR / DP / ED</span>
              </div>
            </div>
          </div>
