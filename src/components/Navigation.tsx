...
import { Menu, X, Play, Film, Disc, Download } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded border border-white/20 bg-white/5 hover:bg-zinc-800 hover:border-white/40 text-xs font-mono text-zinc-300 hover:text-white tracking-widest uppercase transition-all duration-300"
            >
        ...
        >
          ...
          <div className="pt-6 border-t border-white/10 space-y-4">
            ...
            <a
              ...
              download="zeehad-haque-portfolio.zip"
              onClick={() => setMobileMenuOpen(false)}
              className="w-full py-2.5 px-4 border border-white/15 bg-white/5 hover:bg-white/10 text-zinc-300 hover:text-white font-mono text-xs tracking-widest uppercase flex items-center justify-center gap-2 rounded transition-colors"
            >
