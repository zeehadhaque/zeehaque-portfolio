        ...
        {isSubmitted ? (
          <div className="py-12 text-center space-y-4">
            ...
            <button
              type="button"
              onClick={handleReset}
              className="mt-4 px-6 py-2.5 bg-white/10 hover:bg-white/20 text-white font-mono text-xs tracking-widest uppercase rounded"
            >
              RETURN TO ARCHIVE
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 font-mono text-xs">
            ...
            <div className="pt-2 flex items-center justify-between">
              <span className="text-[10px] text-zinc-500">
                DIRECT TRANSMISSION TO ZEEHAD HAQUE
              </span>
              <button
                type="submit"
                data-cursor="button"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#b91c1c] hover:bg-red-700 text-white font-mono text-xs tracking-widest uppercase rounded shadow-lg transition-all"
              >
